...
Item {
            ...
            ColumnLayout {
                ...
                RowLayout {
                    ...
                    ColumnLayout {
                        spacing: 0
                        CustomText {
                            name: I18nService.tr("kitty_opacity_title")
                            isBold: true
                            size: "small"
                        }
                        CustomText {
                ...
                RowLayout {
                    ...
                    transformOrigin: Item.Left
                    CustomText {
                        name: I18nService.tr("kitty_sessions")
                        size: "xs"
                        color: theme.primary.dim_foreground
                    }
                    Item { Layout.fillWidth: true }
                ...
                CustomText {
                    ...
                    size: "xs"
                    color: theme.primary.dim_foreground
                    name: I18nService.tr("kitty_no_sessions")
                }
                ...
                Flow {
                    ...
                    CustomRectangle {
                        ...
                        CustomText {
                            id: allLabel
                            anchors.centerIn: parent
                            name: I18nService.tr("select_all")
                            size: "xs"
                ...
                ColumnLayout {
                    ...
                    RowLayout {
                        Layout.fillWidth: true
                        CustomText {
                            name: I18nService.tr("theme_label")
                            size: "xs"
                            color: theme.primary.dim_foreground
                        }
                        Item { Layout.fillWidth: true }
                    ...
                    Flickable {
                        ...
                        ColumnLayout {
                            ...
                            CustomText {
                                ...
                                size: "xs"
                                color: theme.primary.dim_foreground
                                name: I18nService.tr("kitty_no_themes")
                            }
                        }
                    }
                }
                ...
                ColumnLayout {
                    ...
                    RowLayout {
                        Layout.fillWidth: true
                        CustomText {
                            name: I18nService.tr("font_label")
                            size: "xs"
                            color: theme.primary.dim_foreground
                        }
                        Item { Layout.fillWidth: true }
                    ...
                    Flickable {
                        ...
                        ColumnLayout {
                            ...
                            CustomText {
                                ...
                                size: "xs"
                                color: theme.primary.dim_foreground
                                name: I18nService.tr("kitty_no_fonts", {dir: (KittyOpacityService.userFontDir || "~/.local/share/fonts")})
                            }
                        }
                    }
                }
                ...
                RowLayout {
                    ...
                    CustomText {
                        name: I18nService.tr("custom_text_color")
                        size: "xs"
                        color: theme.primary.dim_foreground
                    }
    ...
    ColorDialog {
        id: fgColorDialog
        title: I18nService.tr("choose_kitty_text_color")
